...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], hostBindings: function AppComponent_HostBindings(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("dragover", function AppComponent_dragover_HostBindingHandler($event) { return ctx.onFileDragOrDrop($event); }, false, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresolveWindow"])("drop", function AppComponent_drop_HostBindingHandler($event) { return ctx.onFileDragOrDrop($event); }, false, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresolveWindow"]);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _models_file_slot__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/file-slot */ "./src/app/models/file-slot.ts");
/* harmony import */ var _printing_board_auxiliary_fileReader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../printing-board/auxiliary/fileReader */ "./src/app/printing-board/auxiliary/fileReader.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var ng2_pdfjs_viewer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng2-pdfjs-viewer */ "./node_modules/ng2-pdfjs-viewer/__ivy_ngcc__/index.js");
...
function PdfSlotComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PdfSlotComponent_div_1_Template_button_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.removeFile(); });
...
PdfSlotComponent.ɵfac = function PdfSlotComponent_Factory(t) { return new (t || PdfSlotComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_printing_board_auxiliary_fileReader__WEBPACK_IMPORTED_MODULE_2__["PdfFileReader"])); };
PdfSlotComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PdfSlotComponent, selectors: [["app-pdf-slot"]], viewQuery: function PdfSlotComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { slot: "slot" }, decls: 2, vars: 2, consts: [["class", "add-file__wrapper", 4, "ngIf"], ["class", "viewer-wrapper", 4, "ngIf"], [1, "add-file__wrapper"], ["type", "file", 3, "change"], [1, "viewer-wrapper"], ["zoom", "98", 3, "pdfSrc", "viewerId", "onDocumentLoad"], ["viewer", ""], [1, "remove-file", 3, "click"]], template: function PdfSlotComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PdfSlotComponent, [{
    ...
    }], function () { return [{ type: _printing_board_auxiliary_fileReader__WEBPACK_IMPORTED_MODULE_2__["PdfFileReader"] }]; }, { pdfAppComponent: [{
...
/* harmony import */ var _pdf_slot_pdf_slot_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../pdf-slot/pdf-slot.component */ "./src/app/pdf-slot/pdf-slot.component.ts");





function PrintingBoardComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 4);
...
class PrintingBoardComponent {
    ...
    ngOnInit() {
        this.availableSlots = [
            { id: 'id1', status: _models_file_slot__WEBPACK_IMPORTED_MODULE_1__["FileStatus"].empty },
            { id: 'id2', status: _models_file_slot__WEBPACK_IMPORTED_MODULE_1__["FileStatus"].empty },
            { id: 'id3', status: _models_file_slot__WEBPACK_IMPORTED_MODULE_1__["FileStatus"].empty },
            { id: 'id4', status: _models_file_slot__WEBPACK_IMPORTED_MODULE_1__["FileStatus"].empty },
        ];
    }
    printBoard() {
        window.print();
    ...
    fileIsLoading() {
        return !!this.availableSlots.find(s => s.status === _models_file_slot__WEBPACK_IMPORTED_MODULE_1__["FileStatus"].loading);
    }
}
PrintingBoardComponent.ɵfac = function PrintingBoardComponent_Factory(t) { return new (t || PrintingBoardComponent)(); };
PrintingBoardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PrintingBoardComponent, selectors: [["app-printing-board"]], decls: 5, vars: 2, consts: [[1, "button-wrapper"], [3, "disabled", "click"], [1, "board-wrapper"], ["class", "quarter", 4, "ngFor", "ngForOf"], [1, "quarter"], [3, "slot"]], template: function PrintingBoardComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "button", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PrintingBoardComponent_Template_button_click_1_listener() { return ctx.printBoard(); });
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _pdf_slot_pdf_slot_component__WEBPACK_IMPORTED_MODULE_3__["PdfSlotComponent"]], styles: [".button-wrapper[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n}\n\n.button-wrapper[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  height: 32px;\n  width: 64px;\n  margin: 32px 0 8px 0;\n  cursor: pointer;\n}\n\n.button-wrapper[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:disabled {\n  cursor: not-allowed;\n}\n\n.button-wrapper[_ngcontent-%COMP%], .board-wrapper[_ngcontent-%COMP%] {\n  width: calc(80vh * 0.71);\n  margin: auto;\n}\n\n.board-wrapper[_ngcontent-%COMP%] {\n  height: 80vh;\n  padding: 32px calc(32px * 0.71);\n  border: 1px solid #000;\n  display: grid;\n  grid-template-columns: 50% 50%;\n  grid-template-rows: 50% 50%;\n}\n\n.quarter[_ngcontent-%COMP%] {\n  border: 1px solid #000;\n}\n\n@media print {\n  button[_ngcontent-%COMP%] {\n    display: none;\n  }\n\n  .board-wrapper[_ngcontent-%COMP%] {\n    height: 1123px;\n    width: 794px;\n    padding: 0;\n    border: none;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
